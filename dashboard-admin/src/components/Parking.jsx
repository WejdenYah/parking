import {
  ...
  export default function Parkings() {
    ...
    const fetchParkings = async () => {
      try {
        const response = await axios.get("http://localhost:8800/api/parks");
    ...
    const deleteParkings = async (parkingId) => {
      try {
        await axios.delete(`http://localhost:8800/api/parks/${parkingId}`);
        fetchParkings();
      } catch (error) {
        console.log(error);
      }
    ...
    const addParking = async () => {
      try {
        await axios.post("http://localhost:8800/api/parks", newParking);
        fetchParkings();
        handleCloseAdd();
      } catch (error) {
        console.log(error);
    ...
    const updateParking = async () => {
      try {
        await axios.put(`http://localhost:8800/api/parks/${editParking._id}`, editParking);
        fetchParkings();
        handleCloseEdit();
      } catch (error) {
        console.log(error);
