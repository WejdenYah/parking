...
export default function Statistics() {
  ...
  useEffect(() => {
    axios.get('http://localhost:8800/api/parks/count')
      .then(response => {
    ...
    axios.get('http://localhost:8800/api/reservations/count')
      .then(response => {
    ...
    axios.get('http://localhost:8800/api/reservations/monthly-count')
      .then(response => {
    ...
    axios.get('http://localhost:8800/api/users/count')
      .then(response => {
